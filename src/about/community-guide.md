...
- 關注我們的[官方 Twitter 賬號](https://x.com/vuejs)。
...
- [GitHub](https://github.com/vuejs)：如果你想報告 bug 或者提出新特性需求，歡迎來 GitHub 提交 issue。請遵守每個倉庫 issue 模板中所列明的規範。
- [Twitter 社區 (非官方)](https://x.com/i/communities/1516368750634840064)：一個 Twitter 社區，在那裡你可以認識其他 Vue 愛好者、獲得幫助或討論 Vue 的相關話題。
...
對於如何參與當地的 Vue 社區，如果你有任何問題，請通過 Twitter 聯繫 [@vuejs_events](https://x.com/vuejs_events)！
